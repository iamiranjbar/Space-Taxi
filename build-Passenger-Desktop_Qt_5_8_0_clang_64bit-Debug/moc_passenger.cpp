...
QT_MOC_LITERAL(3, 35, 29) // "on_signup_page_button_clicked"

    },
    "Passenger\0on_login_button_clicked\0\0"
    "on_signup_page_button_clicked"
};
...
void Passenger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Passenger *_t = static_cast<Passenger *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_login_button_clicked(); break;
        case 1: _t->on_signup_page_button_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Passenger::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Passenger.data,
      qt_meta_data_Passenger,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Passenger::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Passenger.stringdata0))
        return static_cast<void*>(const_cast< Passenger*>(this));
